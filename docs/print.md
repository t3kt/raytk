...
[src]: https://github.com/hydecorp/hy-starter-kit/archive/v9.0.0-rc.9.zip
...
~~~bash
$ cd ~/Downloads/hydejack-pro-9.0.0-rc.9/install/
~~~
...
author:
  social:
    ...
    download: https://github.com/hydecorp/hydejack/archive/v9.0.0-rc.9.zip
~~~
