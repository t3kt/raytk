...
[src]: https://github.com/hydecorp/hy-starter-kit/archive/v9.0.0-rc.2.zip
...
~~~bash
$ cd ~/Downloads/hydejack-pro-9.0.0-rc.2/install/
~~~
...
```yml
remote_theme: hydecorp/hydejack@v9.0.0-rc.2
```
...
author:
  social:
    ...
    download: https://github.com/hydecorp/hydejack/archive/v9.0.0-rc.2.zip
~~~
