...
[src]: https://github.com/hydecorp/hy-starter-kit/archive/v9.0.0-rc.7.zip
...
~~~bash
$ cd ~/Downloads/hydejack-pro-9.0.0-rc.7/install/
~~~
...
author:
  social:
    ...
    download: https://github.com/hydecorp/hydejack/archive/v9.0.0-rc.7.zip
~~~
