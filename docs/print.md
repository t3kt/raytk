...
[src]: https://github.com/hydecorp/hy-starter-kit/archive/v9.0.0-beta.3.zip
...
~~~bash
$ cd ~/Downloads/hydejack-pro-9.0.0-beta.3/install/
~~~
...
```yml
remote_theme: hydecorp/hydejack@v9.0.0-beta.3
```
...
author:
  social:
    ...
    download: https://github.com/hydecorp/hydejack/archive/v9.0.0-beta.3.zip
~~~
