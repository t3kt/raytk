...
~~~bash
$ cd ~/Downloads/hydejack-pro-9.0.0-beta.0/install/
~~~
...
```yml
remote_theme: hydecorp/hydejack@v9.0.0-beta.0
```
...
author:
  social:
    ...
    download: https://github.com/hydecorp/hydejack/archive/v9.0.0-beta.0.zip
~~~
